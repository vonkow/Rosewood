...
var hero = function(name) {
	this.base = new rw.ent(this, name, 'hero', 'd1', 'gif', 30, 30);
	this.heading = 'd';
...
var eye = function(name, heading) {
	this.base = new rw.ent(this, name, 'eye', heading+1, 'gif', 30, 30);
...
var item = function() {
	this.base = new rw.ent(this, 'item'+itemCounter++, 'items', 'question', 'gif', 30, 30);
...
var fatimaNotification = function() {
	this.base = new rw.ent(this, 'fatimanotification'+itemCounter, 'notifications', 'fatima', 'gif', 90, 30);
	this.update = function() {
		if (!fatima) {
			this.base.hide();
			return false;
...
var blindEyeNotification = function() {
	this.base = new rw.ent(this, 'blindeyenotification'+itemCounter, 'notifications', 'blindeye', 'gif', 90, 30);
	this.update = function() {
		if (!blind) {
			this.base.hide();
			return false;
...
var slowNotification = function() {
	this.base = new rw.ent(this, 'slownotification'+itemCounter, 'notifications', 'slow', 'gif', 90, 30);
	this.update = function () {
		if (!slow) {
			this.base.hide();
			return false;
...
var badLuckNotification = function() {
	this.base = new rw.ent(this, 'badlucknotification'+itemCounter, 'notifications', 'badluck', 'gif', 90, 30);
	this.update = function() {
		if (!badLuck) {
			this.base.hide();
			return false;
...
var deadEyes=function() {
	this.base= new rw.ent(this, 'eyecounter','',' ','',100,50);
	this.update=function() {
		this.base.detach();
