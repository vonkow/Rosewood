...
var Wall = function(name, wallType, xDim, yDim) {
	this.base = new rw.ent(this,name, ' ', ' ', ' ', xDim, yDim);
	this.hitMap = [[wallType,['bman'],0,0,xDim,yDim]];
	this.update = function() {};
}

var blast = function(name) {
	this.base = new rw.ent(this,name, 'blast', 'blast', 'gif', 40, 32);
	this.countdown = 25;
	this.update = function() {
...
var bomb = function(name, typeClass) {
	this.base = new rw.ent(this,name, 'bomb', '1', 'gif', 40, 32);
	this.countdown = 150;
	this.blastSize = 2;
	this.update = function() {
...
var badguy = function(name) {
	this.base = new rw.ent(this,name, 'bman', 'l', 'gif', 40, 64);
	this.speed = 5;
	this.ticker = 0;
	this.heading = 'l';
	this.countdown = 100;
...
var bman = function(name, typeClass, heading) {
	this.base = new rw.ent(this,name, 'bman', 'u', 'gif', 40, 64);
	this.maxSpeed = 5;
	this.bombCooldown = 5;
	this.bombMax = 15;
	this.bombs = [];
