...
var startGame = function() {
	...
	.newEnt(new dot('dot1', 'dot')).base.display('ball', 280, 280, 280).end()
	.newEnt(new  Wall('tWall', 'tWall', 599, 1)).base.display('blank', 0, 0, 0).end()
	.newEnt(new  Wall('rWall', 'rWall', 1, 599)).base.display('blank', 600, 0, 0).end()
	.newEnt(new  Wall('lWall', 'lWall', 1, 599)).base.display('blank', 0, 1, 0).end()
	.newEnt(new  Wall('bWall', 'bWall', 599, 1)).base.display('blank', 1, 600, 0).end()
	.start()
}
